...
class BookingCourtService {
  static Future<List<San1DayCTA>> fetchBookingData(String userId) async {
    final response = await http.get(Uri.parse(getbookingcourt),
    headers: {
    ...
    if (response.statusCode == 200) {
      ...
      return jsonResponse.map((response) => San1DayCTA.fromJson(response)).toList();
      ...
      return dataList.map((data) => San1DayCTA.fromJson(data)).toList();
    } else {
